    ...
    class program
    {
        public static void Main(string[] args)
        {
            ...
            List<ProductReview> ProductReviewList = new List<ProductReview>()
            {
                ...
                new ProductReview(){ProductID=5, UserID=1, Rating=4,Review="Good",IsLike=true},
                ...
                new ProductReview(){ProductID=23, UserID=10, Rating=5,Review="nice",IsLike=true},
                new ProductReview(){ProductID=24, UserID=10, Rating=5,Review="nice",IsLike=true},
