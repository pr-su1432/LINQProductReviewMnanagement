    ...
    class program
    {
        public static void Main(string[] args)
        {
            ...
            List<ProductReview> ProductReviewList = new List<ProductReview>()
            {
                ...
                new ProductReview(){ProductID=5, UserID=10, Rating=4,Review="very bad",IsLike=true},
                ...
                new ProductReview(){ProductID=18, UserID=7, Rating=7,Review="Good",IsLike=true},
                ...
                new ProductReview(){ProductID=21, UserID=9, Rating=5,Review="nice",IsLike=true},
                ...
                new ProductReview(){ProductID=25, UserID=8, Rating=5,Review="nice",IsLike=false},
            };
           ...
           // DataTable table = review.createDatatable(ProductReviewList);
            ...
            DataTable table = review.createDatatable(ProductReviewList);
            review.retrieveUserID10Records(table);
        }
    }
}